...
public class UserConverter implements EntityDtoConverter<User, UserDTO> {
    ...
    public User dtoToEntity(UserDTO userDTO) {
        return new User(userDTO.getId(), userDTO.getFirstName(), userDTO.getLastName(), userDTO.getEmail(), userDTO.getRegisteredAt(),userDTO.getCity(),userDTO.getZipCode(),userDTO.getPhone(),userDTO.getIdDocument(),userDTO.getPassword());
    }
