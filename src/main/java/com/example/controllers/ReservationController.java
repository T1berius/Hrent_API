...
public class ReservationController {
    ...
    public HttpStatus createReservation(@Param("idUser") Integer idUser,
    ...
    public HttpStatus updateReservation(@PathVariable("id") Integer id,
    ...
    public HttpStatus acceptReservation(@PathVariable("id") Integer id) {
    ...
    public HttpStatus declineReservation(@PathVariable("id") Integer id) {
        if(!reservationRepository.findById(id).isEmpty()) {
            ReservationConverter reservationConverter = new ReservationConverter();
            ReservationDTO reservationDTO = reservationConverter.entityToDto(reservationRepository.findById(id).get());
            reservationDTO.setId(id);
