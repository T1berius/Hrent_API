...
/*
    ...
    public void testCreateAndGetAnnounce() throws Exception {
        ...
        mockMvc.perform(get("/api/announces")).andExpect(status().isOk()).andExpect(content().contentTypeCompatibleWith(MediaType.APPLICATION_JSON)).andExpect(jsonPath("$[0].title",is("Maison de campagne")));
    }
